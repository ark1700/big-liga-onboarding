...
/* harmony import */ var _modules_tablet_click__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/tablet-click */ "./js/modules/tablet-click.js");
...
Object(_modules_loader__WEBPACK_IMPORTED_MODULE_2__["loader"])();
Object(_modules_tablet_click__WEBPACK_IMPORTED_MODULE_3__["tabletClick"])();
...
var loaderClickHandler = function loaderClickHandler() {
  hideLoader();
  document.removeEventListener('keydown', loaderClickHandler);
};

var loaderKeydownHandler = function loaderKeydownHandler(e) {
  if (e.key === 'Enter') {
    hideLoader();
...
/***/ "./js/modules/tablet-click.js":
/*!************************************!*\
  !*** ./js/modules/tablet-click.js ***!
  \************************************/
/*! exports provided: tabletClick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tabletClick", function() { return tabletClick; });
var mainBlock = document.querySelector('.main');
var isTabelt = window.matchMedia('(max-width: 1023px)').matches;
var loaderBlock = document.querySelector('.loader');

var tabletClick = function tabletClick() {
  document.addEventListener('click', function (e) {
    var isLinkTarget = e.target.closest('.header__link');
